...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 180.0, 291.0, 93.0, 20.0 ],
					"text" : "buffer.model #1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-7::obj-58" : [ "live.text[4]", "live.text[4]", 0 ],
			"obj-1::obj-32" : [ "spat[9]", "spat", 0 ],
			"obj-1::obj-19" : [ "harm[9]", "harm", 0 ],
			"obj-1::obj-18" : [ "delay[10]", "delay", 0 ]
		}
,
		"dependency_cache" : [ 			{
