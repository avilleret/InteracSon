...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"annotation" : "Plays one grain of buffer each time it receives a note",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-3",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 382.0, 80.0, 20.0 ],
					"text" : "grain~.model"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 222.0, 225.0, 123.0, 20.0 ],
					"text" : "poly~ grain~.model 2"
				}
